							...
							$.ajax({
								...
								datisegn.forEach(function(arrayItem) {
								    if (arrayItem["Zona"] == feature.properties.Nome_zona) {
									    ...
									    $('#pulsanteSEGN').append('<div class="row" id="SegnalazioniButton"><form><label class="radio-inline btn btn-danger text-left"><input type="radio" id="segnalazioni" value="segnalazioni" name="radioseg" autocomplete="off" checked>Tutte le Segnalazioni </label><label class="radio-inline btn btn-dark text-right"><input type="radio" id="sociale" value="sociale" name="radioseg" autocomplete="off"> Sociale </label><label class="radio-inline btn btn-success text-right"><input type="radio" id="ambientale" value="ambientale" name="radioseg" autocomplete="off"> Ambientale </label><label class="radio-inline active btn btn-warning text-right"><input type="radio" id="microcriminalita" value="microcriminalita" name="radioseg" autocomplete="off"> Microcriminalità </label></form></div>');
