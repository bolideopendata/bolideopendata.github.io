                                    ...
                                    success: function(datisegn) {
                                        datisegn.forEach(function(arrayItem) {
                                            if (arrayItem["Zona"] == feature.properties.Nome_zona) {
                                                ...
                                                $('#empty').remove();
                                                $('#EleChartbar').remove();
                                                $('#pulsanteELE').append('<div class="row" id="ELEButton"><div class="col-xs-8 text-left"><form><label class="radio-inline btn btn-dark"><input type="radio" id="camera" value="camera" name="radioele" autocomplete="off" checked>Camera dei Deputati</label><label class="radio-inline btn btn-dark"><input type="radio" id="senato" value="senato" name="radioele" autocomplete="off">Senato</label></form></div><div class="col-xs-4 text-right"id="elettori"></div></div>');                                               
